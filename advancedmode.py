...
class AdvancedMode(tk.Tk):
    ...
    def __init__(self):
        ...
        self.lblTitle = Label(self.Tops, font=("arial", 80, 'bold'), text="Advanced Puzzle Game", bd=10, bg="Cadet Blue",
        ...
        self.LeftFrame = Frame(self.MainFrame, bg="Cadet Blue", bd=10, width=700, height=500, pady=2, relief=RIDGE)
        ...
        btnShuffle = Button(self.RightFrame2a, text="New Game", font=("arial", 40), bd=5, command=self.shuffle).place(x=0, y=10,
                                                                                                            width=480,
                                                                                                            height=100)
